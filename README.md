...
|-----------|--------|--------|-------|
| Python stdlib | `random`, `PYTHONHASHSEED` | ✅ Always available | Seeds built-in random module |
| NumPy | `numpy.random` | ✅ Optional | Seeds global RNG and returns Generator |
| PyTorch | `torch` | ✅ Optional | Seeds CPU, CUDA, cuDNN determinism |
| TensorFlow | `tensorflow` | ✅ Optional | Seeds TF and sets deterministic ops |
| JAX | `jax.random` | ✅ Optional | Returns PRNG key |
| scikit-learn | `sklearn` | ✅ Optional | Provides RandomState utilities |
| Distributed | `torch.distributed`, Horovod, DeepSpeed | ✅ Optional | Rank-aware seeding |
...
## ⚠️ Important Notes on Determinism
